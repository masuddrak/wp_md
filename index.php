...
<body>
  ...
  <section class="banner" role="banner">
    <header id="header">
      <!-- navigation section  -->
      <div class="header-content clearfix"> <a class="logo" href="#"><img src="images/logo.png" alt="Moshiur"></a>
      ...
      <div class="container">
        <div class="col-md-12">
          ...
          <p>© 2021 All rights reserved.<br>
            Made with <i class="fa fa-heart pulse"></i> by <a href="https://moshiur.me/">Moshiur</a>
          </p>
        </div>
      </div>
    </div>
